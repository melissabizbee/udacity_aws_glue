# Sanitize the Customer data (Trusted Zone) and create a Glue Table (Curated Zone) 
# that only includes customers who have accelerometer data and have agreed to share their data for research called customers_curated.
...
CustomerCurated_node3 = glueContext.write_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "path": "s3://stedi-aws-project/curated/customer/",
        "partitionKeys": [],
    },
